...
class ComputerPriceVisitorOnlyMemoryTest {
	...
	void testOfDifferentPrices() {
		...
		ComputerPriceVisitorOnlyMemory shpCal = new ComputerPriceVisitorOnlyMemory();
		...
		int expected_test_4 = actual_test1 + expected_test2 + expected_test3 + 2;
